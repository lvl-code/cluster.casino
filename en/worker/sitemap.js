...
export const sitemapbackupEngine = {
  async generate(db, type = "all") {
    ...
    if (type === "all") {
      xml += `  <url>\n    <loc>https://cluster.casino/en/</loc>\n    <lastmod>${currentDate}</lastmod>\n    <changefreq>daily</changefreq>\n    <priority>1.0</priority>\n  </url>\n`;
      xml += `  <url>\n    <loc>https://cluster.casino/en/casino</loc>\n    <lastmod>${currentDate}</lastmod>\n    <changefreq>daily</changefreq>\n    <priority>0.9</priority>\n  </url>\n`;
      xml += `  <url>\n    <loc>https://cluster.casino/en/review</loc>\n    <lastmod>${currentDate}</lastmod>\n    <changefreq>daily</changefreq>\n    <priority>0.8</priority>\n  </url>\n`;
      xml += `  <url>\n    <loc>https://cluster.casino/en/news</loc>\n    <lastmod>${currentDate}</lastmod>\n    <changefreq>daily</changefreq>\n    <priority>0.7</priority>\n  </url>\n`;
      xml += `  <url>\n    <loc>https://cluster.casino/en/category</loc>\n    <lastmod>${currentDate}</lastmod>\n    <changefreq>weekly</changefreq>\n    <priority>0.6</priority>\n  </url>\n`;
      xml += `  <url>\n    <loc>https://cluster.casino/en/country</loc>\n    <lastmod>${currentDate}</lastmod>\n    <changefreq>weekly</changefreq>\n    <priority>0.6</priority>\n  </url>\n`;
    }
    ...
    if (type === "all" || type === "casinos") {
      ...
      (r.results || []).forEach(item => {
        const lm = item.updated_at ? item.updated_at.split(' ')[0] : currentDate;
        xml += `  <url>\n    <loc>https://cluster.casino/en/casino/${item.slug}</loc>\n    <lastmod>${lm}</lastmod>\n    <changefreq>weekly</changefreq>\n    <priority>0.8</priority>\n  </url>\n`;
      });
    }
    ...
    if (type === "all" || type === "reviews") {
      ...
      (r.results || []).forEach(item => {
        const lm = item.updated_at ? item.updated_at.split(' ')[0] : currentDate;
        xml += `  <url>\n    <loc>https://cluster.casino/en/review/${item.slug}</loc>\n    <lastmod>${lm}</lastmod>\n    <changefreq>weekly</changefreq>\n    <priority>0.7</priority>\n  </url>\n`;
      });
    }
